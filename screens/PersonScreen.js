      ...
      <View>
        ...
        <View className="my-6 mx-4 space-y-2">
          ...
          <Text className="text-neutral-300 tracking-wide">
            ...
            surge in popular and commercial success since the late 2000s.[2] In
            2008, Downey was named by Time magazine as one of the 100 most
            influential people in the world. From 2013 to 2015, he was listed by
            Forbes as Hollywood's highest-paid actor.
          </Text>
        </View>
        {/* movies */}
